...
const steps = [
  {
    num: '01',
    category: 'DISCOVERY',
    title: 'Specification Brief',
    body: 'You share drawings, unit counts, and design direction. We assess scope, quantities, and lead times.',
    detail: ['Project brief and drawings review', 'Unit count and scale assessment', 'Design direction and finish preferences', 'Lead time and budget alignment'],
  ...
  },
  {
    ...
    detail: ['Architectural drawings and elevations', 'Material and finish specification', 'Custom configuration drafting', 'Client approval package before production'],
  ...
  },
  {
    ...
    body: 'Full proposal with selections, quantities, pricing, and production timelines, ready for your sign-off.',
    detail: ['Complete specification and pricing package', 'Itemised quantities and unit economics', 'Production timeline confirmed', 'Written sign-off before manufacturing begins'],
  ...
  },
  {
    ...
    body: 'Coordinated delivery to your site with customs and freight managed end-to-end, and dedicated after-sales support.',
    detail: ['End-to-end freight and customs management', 'Phased delivery to match construction schedule', 'Installation guidance and site coordination', 'Dedicated after-sales support'],
    ...
    <div className="bg-cream">
      ...
      <section className="bg-navy py-24">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <Link to="/trade" className="text-xs text-cream/40 hover:text-cream font-sans tracking-widest uppercase mb-8 block transition-colors">
            ← For Developers
          </Link>
          ...
          <h1 className="font-serif text-5xl md:text-6xl text-cream tracking-tight max-w-2xl">
            From Specification<br /><em className="text-gold italic">to Site Delivery</em>
          </h1>
